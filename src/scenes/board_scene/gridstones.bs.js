...
function modify_slot(board_state, position, state) {
  switch (state) {
    case 0 : 
        Caml_array.caml_array_set(Caml_array.caml_array_get(board_state, position[/* y */1]), position[/* x */0], 1);
        return /* NEW */2;
    case 1 : 
        Caml_array.caml_array_set(Caml_array.caml_array_get(board_state, position[/* y */1]), position[/* x */0], 0);
        return /* EMPTY */0;
    case 2 : 
        return /* NEW */2;
    case 3 : 
